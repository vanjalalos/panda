...
const HeaderTwo = () => {
  const { toggleSideMenu, sideMenuOpen, toggleSearchMenu } = useContext(
    AppContext
  ) as AppContextType;
  ...
  return (
    <>
      <header>
        <HeaderTop />
        <div
          className={`header-area transparent-header sticky-header2 white-bg ${
              ...
              <div className="row align-items-center">
                ...
                <div className="col-xl-6 col-4">
                  ...
                  <div className="side-menu-icon d-xl-none text-end">
                    ...
                    <button
                      className="side-toggle side-toggle2"
                ...
                <div className="col-xl-4 d-none d-xl-block">
                  <div className="header-right text-end">
                    <div className="header-social header-social-2">
                      ...
                      <Link
                        href="https://www.facebook.com/knjigovodstvenibiropanda/photos/?_rdr"
                        target="_blank"
                        rel="noreferrer"
                      >
