...
import slideBg1 from "../../../public/assets/img/slider/image-slider-1.jpg";
import slideBg2 from "../../../public/assets/img/slider/image-slider-2.jpg";
import slideBg3 from "../../../public/assets/img/slider/image-slider-3.jpg";
import slika1 from "../../../public/assets/img/slider/image-slider-23.jpg";
...
const hero_slider: heroType[] = [
  {
    ...
    subTitle: "Dobro došli u Knjigovodstvenu Agenciju",
    btn: "Saznajte više",
    shapeA: shape1,
    shapeB: shape2,
  },
                ...
                <SwiperSlide key={item.id}>
                  ...
                  >
                    <div
                      className="slide-bg"
                      style={{ 
                        backgroundImage: `url(${item.slideBg.src})`,
                        filter: (item.id === 1 || item.id === 4) ? "grayscale(100%)" : "none"
                      }}
                    ></div>
                      ...
                      <div className="row">
                        <div className="col-lg-12">
                          <div className="kslider z-index">
                            <h5 className="kslider--subtitle mb-25">
                              {item.subTitle}
                            </h5>
                            <h2 className="kslider--title mb-40">
                              {item.title}
                            </h2>
